Cephalons are chosen by the player to be a part of his or her deck.

They are not cards.

Available Cephalons for this are:
Apnar:
...
Cordylon:
Cephalon Cordylon is a recurring character within the Warframe community. They answer questions from Tenno about the universe of Warframe in the biweekly Ask A Cephalon blog column.
...
Daklo:
Daklo is a Cephalon stationed on Tauron Academy. Debuting in The Old Peace, Daklo openly shows his disdain toward the Sentients.

Jordas:
Cephalon Jordas is a IconCorpusOn Corpus Cephalon that was first introduced in The Jordas Precept.
...
Initially slated to be added in along with the introduction of Riven Mods, the development of Samodeus' lore was not yet complete in time for its release and was ultimately scrapped. At this time, Cephalon Samodeus has not received any additional lore and has only been directly tied to the Riven Mods system, leaving queries as to how or why the Riven Mods were created under speculation.

Sark:
Cephalon Sark is the host of The Index, and also one of the Cephalons in Conclave Cephalon Capture mode. In the latter, Sark is characterized primarily by his referring to Tenno of the opposing team as fish and insulting them in various ways based on this credence, he occasionally speaks in third-person when stating a feeling. He appears to be very loyal to his team and will call out for them to rescue him when in enemy hands.

Simaris:
CephalonSimarisSigil Cephalon Simaris (or referred to as Irmis by Cephalon Suda) is a Cephalon construct that resides within the Sanctuary Enclave, a room found in all Tenno Relays, which is accessible by visiting any Relay and then using Fast Travel from the Main Menu: default Esc  → FAST TRAVEL → CEPHALON SIMARIS. A seeker of knowledge, his ultimate goal is to "immortalize" creatures through the process known as Synthesis, that deconstructs a being and preserves them as data for further research within the Sanctuary.

Vull:
Cephalon Vull is one of the Cephalons in Conclave Cephalon Capture mode. Vull is characterized by a sadistic personality expressed in an otherwise cheery tone. She does not seem particularly choosy as to which team she prefers, and will congratulate Tenno playing for either the Sun or Moon team as long as they kill others in her presence.
...
Melica:
Every 3 turns a random card on your board gains +50 max health and +50 max shields.
This also heals the card by 10 health and grants it 10 shields.

Ordis:
Every time you play a card, 10% chance to have its cost refunded to you.

Samodeus:
At the start of the game, one random attacker card in your deck is going to gain the following OnTurn action:
Samodeus's Blessing: Deal 50 magnetic damage, 30% status chance, 10% critical chance, 1.5x multiplier, per turn to the card with the highest effective HP.
The said card will also go up in rarity by one level.
