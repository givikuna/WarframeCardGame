...
export class Truth implements IFactionSyndicateEffectMechanic {
        ...
        em.subscribe("SYNDICATE_METER_FILLED", (payload: GameEventPayload["SYNDICATE_METER_FILLED"]): void => {
            ...
            enemy.getCards().forEach((card: Card): void => {
                DamageInstance.init(
                    card,
                    this,
                    { [DamageTypePerSyndicateEffect[SyndicateEffect.Truth]]: 50 },
                    100,
                    0,
                    1,
                ).apply(owner, board);
            ...
            enemy.getOperator().takeDamage(50, DamageTypePerSyndicateEffect[SyndicateEffect.Truth]);
    ...
    public static getFaction(): FactionSyndicate {
        return FactionSyndicate.ArbitersOfHexis;
    }
}
